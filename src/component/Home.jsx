            ...
            <section className='w-full min-h-screen bg-gray-900'>
                <div className='flex min-h-screen  '>
                    ...
                    <div className='flex  w-full '>
                        ...
                        {/*Home section*/}
                        <div className='flex  flex-col max-h-screen justify-between text-white  bg-gray-800 w-full '>


                            {/*navbar home section*/}
                            <nav className='w-full p-2 pr-7 pl-6 bg-gray-900 rounded-b-2xl h-auto flex items-center justify-between gap-2 mb-4'>
                                ...
                                <button
                                    ...
                                    className=' text-3xl text-purple-200 font-semibold'>&#9776;</button>
                            </nav>



                            <div className='w-full md:h-125 h-150 overflow-y-auto p-4 flex flex-col  gap-6 [scrollbar-width:none] [-ms-overflow-style:none] [&:: webkit-scrollbar]:hidden'>

                                {hide && (<div className='w-full h-180 flex flex-col  items-center justify-center'>
                                    <div className='flex justify-center items-center w-full '>

                                        <h1 className='text-[20px] md:text-3xl font-semibold'>hello i m <span className=' text-[35px] md:text-5xl font-bold  bg-linear-to-r from-pink-600 via-purple-600 to-purple-600  bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(255,100,50,0.2)] animate-text'>Sahil,Assistent!</span></h1>
                                    </div>
                                    ...
                                    <div className='flex flex-wrap w-full md:w-190 h-auto gap-4 mt-8 md:pl-22'>
                            ...
                            <div className='w-full h-auto rounded-b-2xl md:mb-20 flex items-center justify-center    '>
